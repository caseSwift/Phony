  ...
  <div>
    <Section>
      <nav class="navbar fixed-top navbar-expand-md bg-light navbar-light">
        <a class="navbar-brand" href="index.php"><img class="logo" src="images/logo_1.jpg" alt="" width="50" height="40" class="d-inline-block" />&nbsp;&nbsp;Car2Go</a>
            ...
            <div class="card h-100">
              <div class="card-body">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item">Mileage: <?= number_format($row['product_capacity']) ?></li>
